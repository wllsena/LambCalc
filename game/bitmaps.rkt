...
(define (svg->bitmap file)
  (define logo-bytes (file->bytes file))
...
(define trex (svg->bitmap "images/trex.svg"))
(define triceratops (svg->bitmap "images/triceratops.svg"))
(define egg (svg->bitmap "images/egg.svg"))

(define bitmap-figure
  (match-lambda 
    ['trex trex]
